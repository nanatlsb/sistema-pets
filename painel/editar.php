...
$stmt = $conexao->prepare('SELECT * FROM tb_adm WHERE nm_usuario = :usuario and ds_email = :email and ds_senha = :senha');
...
<body class="bg-dark h-100">
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        ...
        <main class="col h-100 text-light p-4">
            ...
            <form action="../php/update_user.php" class="bg-custom rounded col-12 py-3 px-4">
                
                <div class="mb-3 row">
                    <label for="usuario" class="col-sm-2 col-form-label">Usuário:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control bg-dark text-light border-dark" id="usuario" placeholder="Ex: Admin" value="Admin" name="usuario">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control bg-dark text-light border-dark" id="email" placeholder="Ex: admin@kbrtec.com.br" value="admin@kbrtec.com.br" name="email">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" class="form-control bg-dark text-light border-dark" id="senha" name="senha">
                    </div>
                </div>

                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-light">Salvar</button name="id">
                </div>
            </form>
