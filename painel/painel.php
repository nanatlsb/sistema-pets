                    ...
                    <div class="collapse show" id="menu-usuario">
                        ...
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            <a href="solicitacao.php" class="submenu-link link-light text-decoration-none rounded p-2">
                                ...
                                <div class="collapse show" id="menu-usuario">
                                    <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                                        <a href="cadastro_animal.html" class="submenu-link link-light text-decoration-none rounded p-2">
                                            <small class="d-flex justify-content-between align-items-center">
                                                Cadastrar animal
                                            </small>

                                        </a>
                                        <a href="painel.php" class="submenu-link link-light text-decoration-none rounded p-2 active">
                                            <small class="d-flex justify-content-between align-items-center">
                                                Listagem
                ...
                <table class="table mb-0 table-custom table-dark align-middle">
                    ...
                    <tbody>
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            <a href="editar.php" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
